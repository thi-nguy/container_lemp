...
mysql -u root -e "INSERT INTO $DB_NAME.wp_users (user_login,user_pass,user_nicename,user_email,user_url,user_registered,user_activation_key,user_status,display_name) VALUES ('thi-nguy',MD5('thi-nguy'),'','thi-nguy@example.com','https://thi-nguy.42.fr','','',0,'');"
